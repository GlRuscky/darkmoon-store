...
<div class="container mt-5 mb-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="/darkmoon-store/admin/cupons/form.php" class="btn btn-danger">
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a href="/darkmoon-store/admin/cupons/form.php?id=<?= $cupom['id_cupom'] ?>" class="btn btn-outline-light btn-sm">
                                <i class="bi bi-pencil"></i> Editar
                            </a>
                            <?php if ($cupom['ativo']): ?>
                                <a href="/darkmoon-store/admin/cupons/excluir.php?id=<?= $cupom['id_cupom'] ?>"
                                   class="btn btn-outline-danger btn-sm"
                                   onclick="return confirm('Desativar este cupom? Ele deixará de funcionar na loja.');">
                                    <i class="bi bi-x-circle"></i> Desativar
                                </a>
                            <?php else: ?>
                                <a href="/darkmoon-store/admin/cupons/excluir.php?id=<?= $cupom['id_cupom'] ?>&reativar=1"
