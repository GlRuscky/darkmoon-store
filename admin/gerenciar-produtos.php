...
<div class="container mt-5 mb-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="/darkmoon-store/admin/produtos/form.php" class="btn btn-danger">
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a href="/darkmoon-store/admin/produtos/form.php?id=<?= $produto['id_produto'] ?>" class="btn btn-outline-light btn-sm">
                                <i class="bi bi-pencil"></i> Editar
                            </a>
                            <a href="/darkmoon-store/admin/produtos/excluir.php?id=<?= $produto['id_produto'] ?>"
