...
<div class="container mt-5 mb-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="/darkmoon-store/admin/usuarios/form.php" class="btn btn-danger">
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a href="/darkmoon-store/admin/usuarios/form.php?id=<?= $usuario['id_usuario'] ?>" class="btn btn-outline-light btn-sm">
                                <i class="bi bi-pencil"></i> Editar
                            </a>
                            <a href="/darkmoon-store/admin/usuarios/excluir.php?id=<?= $usuario['id_usuario'] ?>"
