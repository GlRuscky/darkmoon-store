...
if ($id) {
    ...
    if (!$encontrado) {
        ...
        header("Location: /darkmoon-store/admin/gerenciar-produtos.php");
        exit;
    }
...
<div class="container mt-5 mb-5" style="max-width: 700px;">
    ...
    <form method="POST" action="/darkmoon-store/admin/produtos/salvar.php">
        <?php if ($id): ?>
        ...
        <a href="/darkmoon-store/admin/gerenciar-produtos.php" class="btn btn-outline-light">Cancelar</a>
    </form>
</div>
