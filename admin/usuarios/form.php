...
if ($id) {
    ...
    if (!$encontrado) {
        ...
        header("Location: /darkmoon-store/admin/gerenciar-usuarios.php");
        exit;
    }
...
<div class="container mt-5 mb-5" style="max-width: 600px;">
    ...
    <form method="POST" action="/darkmoon-store/admin/usuarios/salvar.php">
        <?php if ($id): ?>
        ...
        <a href="/darkmoon-store/admin/gerenciar-usuarios.php" class="btn btn-outline-light">Cancelar</a>
    </form>
</div>
