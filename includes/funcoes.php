...
function exibirProdutoCard($produto) {
    $imagem = !empty($produto['imagem']) ? '/darkmoon-store/images/' . trim($produto['imagem']) : '/darkmoon-store/images/sem-imagem.jpg';
    ...
    <div class="col-md-3 col-sm-6 mb-4">
        <div class="card h-100 bg-secondary text-white border-0 shadow-sm overflow-hidden">
            <img src="' . htmlspecialchars($imagem) . '" 
                 ...
                 onerror="this.src=\'/darkmoon-store/images/sem-imagem.jpg\';">
            ...
            <div class="card-body d-flex flex-column p-3">
                ...
                <div class="mt-auto pt-2">
                    ...
                    <a href="/darkmoon-store/produto.php?id=' . $produto['id_produto'] . '" class="btn btn-outline-light w-100 mb-2">Ver Detalhes</a>
                    <a href="/darkmoon-store/carrinho.php?adicionar=' . $produto['id_produto'] . '" class="btn btn-danger w-100">
