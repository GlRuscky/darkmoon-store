...
<div class="container mt-5 mb-5">
    ...
    <!-- Formulário de cupom -->
    <form method="GET" action="/darkmoon-store/promocoes.php" class="d-flex justify-content-center gap-2 mb-3">
    ...
    <form method="GET" action="/darkmoon-store/promocoes.php" class="d-flex justify-content-center align-items-center gap-2 mb-4">
        ...
        <?php foreach ($produtos as $produto): ?>
            ...
            <div class="col-md-3 col-sm-6 mb-4">
                <div class="card h-100 bg-secondary text-white border-0 shadow-sm">
                    <img src="/darkmoon-store/images/<?= htmlspecialchars(trim($produto['imagem'])) ?>" 
